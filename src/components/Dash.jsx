    ...
    return (
        <div className='dash'>
            <div className="dashcont">
                ...
                <Link to={"/login"}>
                <button  style={{ backgroundColor: "#1f3578", color: "white" }} className="button buttondash">Get Keeper, It's free</button>
                </Link>
            </div>
            ...
            <div style={{ left: "30%", top: "10%" }} className='dashimg dashstar'><img src={str1} alt='img'></img></div>
            <div style={{ right: "25%", top: "40%" }} className='dashimg dashstar'><img style={{ height: "60px", }} src={str1} alt='img'></img></div>
        </div>
    )
}
